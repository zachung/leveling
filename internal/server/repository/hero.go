...
var enemiesJsonData = map[string]string{
	"Enemy1": `{"name": "Enemy1", "Health": 20, "Strength": 1, "mainHand": 0}`,
	"Enemy2": `{"name": "Enemy2", "Health": 20, "Strength": 1, "mainHand": 0}`,
	"Enemy3": `{"name": "Enemy3", "Health": 20, "Strength": 1, "mainHand": 0}`,
}
